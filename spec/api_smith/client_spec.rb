...
describe APISmith::Client do
  ...
  describe 'passing options' do
    ...
    pending 'should allow you to pass extra request options' do
    ...
    pending 'should let you add request options on an instance level' do
      mock.proxy(client_klass).get('/a', hash_including(awesome: true))
    ...
    pending 'should let you override the base level request options' do
      mock.proxy(client_klass).get('/a', hash_including(awesome: true))
